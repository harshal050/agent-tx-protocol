...
[![Website](https://img.shields.io/badge/website-agenttx.site-0b0b0b?logo=vercel&logoColor=white)](https://agenttx.site)
...
**[Website](https://agenttx.site)** · **[Documentation](https://agenttx.site/docs)** · [Quickstart](https://agenttx.site/docs/quickstart) · [Benchmarks](https://agenttx.site/benchmarks) · [Contributing](CONTRIBUTING.md)
...
The same scripted agent and the same tools, run through a naive retry-and-restart loop (**before**) and through AgentTx (**after**). Measured on an AMD Ryzen 5 5600H (12 threads), release build. Explore every chart on the **[benchmarks page](https://agenttx.site/benchmarks)** · raw data: [`benchmarks/results/latest.json`](benchmarks/results/latest.json) · [methodology](https://agenttx.site/docs/benchmark-methodology).
...
Prerequisites: Rust 1.88+, a C++ toolchain and libclang (RocksDB builds from source). See [Installation](https://agenttx.site/docs/installation).
...
Then follow the [Quickstart](https://agenttx.site/docs/quickstart) to trigger your first dependency-jump rollback with `grpcurl`, or wire up your agent with the [client integration guide](https://agenttx.site/docs/client-integration) (Python, TypeScript, Rust).
...
Read [Guarantees & limits](https://agenttx.site/docs/guarantees) for exactly what is and isn't guaranteed.
...
The website — live at **[agenttx.site](https://agenttx.site)** — reads `docs/` and `benchmarks/results/` from GitHub in production, falling back to the local checkout. A push webhook refreshes it. See [`apps/docs/README.md`](apps/docs/README.md) for deployment.
